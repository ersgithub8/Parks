...
import com.example.bookticket.AdminSide.PendingVehicle;
import com.example.bookticket.AdminSide.PendingVehicleEdit;
...
public class PendingVehicleAdapter extends RecyclerView.Adapter<PendingVehicleAdapter.PendingVehicleViewHolder> {
    ...
    Context context;
    Interfaceee interfaceee;
    public PendingVehicleAdapter(Context context,ArrayList<String> no, ArrayList<String> park,
                             ...
                             ArrayList<String> assigntime, ArrayList<String> assigndate, ArrayList<String> completedate, Interfaceee interfaceee) {
        ...
        this.interfaceee=interfaceee;
    }

    @NonNull
    @Override
    public PendingVehicleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater=LayoutInflater.from(parent.getContext());
        View view=inflater.inflate(R.layout.getvehivleitems,parent,false);
        return new PendingVehicleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PendingVehicleViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                interfaceee.onitemClick(no.get(position),driverid.get(position),coordinatorid.get(position),monitorid.get(position));
    ...
    public class PendingVehicleViewHolder extends RecyclerView.ViewHolder{
        TextView parktv,vehicletypetv,regtv,captv,tasktv,coveragetv,deivertv,
                coordinatortv,monitortv,statustv,attv,adtv,cdtv;
        public PendingVehicleViewHolder(@NonNull View itemView) {
            super(itemView);
