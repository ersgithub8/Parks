...
public class ViewRecordBookingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_viewrecord_ticket,container,false);
        recyclerView=view.findViewById(R.id.rvvrvrf);
        sharedPreferences=getContext().getSharedPreferences("UserData", Context.MODE_PRIVATE);
        error=view.findViewById(R.id.errorvrt);
        getbookingrecord();
        return view;
    }
    ...
    private void getbookingrecord() {
        ...
        CustomRequest jsonObjectRequest=new CustomRequest(Request.Method.POST,
                "http://admotors-admin.bazar.com.pk/ci/index.php/api/get_booking_list",
            ...
            public void onResponse(JSONObject response) {
                ...
                try{
                    ...
                    }else
                    {
                        ...
                        recyclerView.setAdapter(new ViewRecordAdapter(getContext(),no,park,date,time,timezone,ticketprice,tptalperson,totalprice,statuss));
